...
const Login = () => {
  ...
  const handleSubmit = (e) => {
    ...
    // Submit form data (email, password) to your backend for authentication
    console.log({ email, password });
    // You would likely call your API here
  };
  ...
  return (
    <div className="w-screen h-screen bg-darker flex flex-col justify-center text-light text-xl josefin-sans">
      <div className='bg-dark shadow-2xl border-purple shadow-purple w-[350px] h-[600px] mx-auto px-6 py-8 rounded-xl'>
        <h2 className="text-center text-[32px] mb-12 font-bold">Login</h2>
        ...
        <form onSubmit={handleSubmit} className="flex flex-col space-y-4 mb-8">
          ...
          <div className="form-group mb-2">
            <label htmlFor="repeatPassword" className="blocktext-md text-md">Repeat Password:</label>
            <input
              type="password"
              id="repeatPassword"
        ...
        <div className="text-center mt-4">
          <p className="text-sm mb-1">Or sign in with:</p>
          <button
            id="googleSignInBtn"
            className="w-full py-2 bg-new-red-500 text-light rounded-md hover:bg-purple transition-all duration-[300ms]"
          >
            Sign in with <span className='text-blue-500'>G</span><span className='text-red-500'>o</span><span className='text-yellow-500'>o</span><span className='text-blue-500'>g</span><span className='text-green-500'>l</span><span className='text-red-500'>e</span>
          </button>
        </div>
      </div>
    </div>
